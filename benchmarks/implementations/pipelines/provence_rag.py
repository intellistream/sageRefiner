...
from sage.middleware.components.sage_refiner import ProvenceRefinerOperator
...
def pipeline_run(config):
    ...
    (
        ...
        .map(ProvenceRefinerOperator, config["provence"])
...
if __name__ == "__main__":
    ...
    if os.getenv("SAGE_EXAMPLES_MODE") == "test" or os.getenv("SAGE_TEST_MODE") == "true":
        print(
            "🧪 Test mode detected - Provence pipeline requires pre-built FAISS index and Provence model"
        )
    ...
    print("🚀 Starting Provence RAG Pipeline...")
    ...
    print(f"🔧 Provence threshold: {config['provence']['threshold']}")
